...
export class AngualertService implements OnDestroy {
  ...
  constructor(private componentFactoryResolver: ComponentFactoryResolver) {
    ...
    this.alerts = new Array<AlertComponent>();
  }
   ...
   */
  public info(message: string, options?: AlertOptions | any): AlertComponent {
   ...
   * @param options The options. Can be ignored
   */
  public success(message: string, options?: AlertOptions | any): AlertComponent {
    let alert = this.loadAlert();
    options = this.getOptions(options);
   ...
   * @param options The options. Can be ignored
   */
  public warn(message: string, options?: AlertOptions | any): AlertComponent {
    let alert = this.loadAlert();
    options = this.getOptions(options);
   ...
   * @param options The options. Can be ignored
   */
  public error(message: string, options?: AlertOptions | any): AlertComponent {
    let alert = this.loadAlert();
    options = this.getOptions(options);
  ...
  public loadAlert(): AlertComponent {
    ...
    let alert = (<AlertComponent>componentRef.instance);
